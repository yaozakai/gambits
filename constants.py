...
# SQLALCHEMY_DATABASE_URI = 'mysql+mysqlconnector://admin:2{C,ZGrm4f[S@185.145.131.100:3306/gambitsv_db'
SQLALCHEMY_DATABASE_URI = 'mysql+mysqlconnector://admin:2{C,ZGrm4f[S@localhost:3306/gambitsv_db'
